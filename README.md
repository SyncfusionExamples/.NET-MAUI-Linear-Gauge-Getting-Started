# .NET MAUI Linear Gauge Getting Started

This repository contains a sample to getting started with [Syncfusion .NET MAUI Linear Gauge](https://help.syncfusion.com/maui/linear-gauge/getting-started) control. The .NET MAUI Linear Gauge is a data visualization control to display data on a linear scale.
